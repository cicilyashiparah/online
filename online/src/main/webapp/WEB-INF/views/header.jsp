...
<link href="<c:url value='/resources/css/cici.css'></c:url>" rel="stylesheet">
<link href="<c:url value='/resources/css/header.css'></c:url>" rel="stylesheet">
	...
	<div class="container font" >
		<nav class="navbar navbar-default">
			<div class="navbar-header">
				<a href="" class="navbar-brand"><img src="<c:url value='/resources/images/images.jpg'></c:url>" alt="JESUS" height="30px" width="70px"></a>
